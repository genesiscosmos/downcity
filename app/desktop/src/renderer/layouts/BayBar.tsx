...
export interface BayBarState {
  ...
  open: boolean;
  /** 当前打开的具体面板。 */
  active_tab: "agent_config" | "group_config";
}
...
/** 只渲染当前存在且被打开的具体上下文面板。 */
export function BayBar({ state, agent_config_content, group_config_content, on_active_tab_change }: BayBarProps) {
