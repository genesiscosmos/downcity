...
export const WorkspaceSidebar = memo(function WorkspaceSidebar({ controller, open_create_workspace }: WorkspaceSidebarProps) {
  ...
  return <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
    ...
    <div data-sidebar-scrollable="true" className="sidebar-body-scroll min-h-0 flex-1 overflow-y-auto px-2 pb-2">
      ...
      {!loading && workspaces.length === 0 ? <div className="flex flex-col items-center px-4 py-10 text-center"><TbFolderPlus className="mb-2 size-5 text-muted-foreground" /><div className="text-xs text-foreground">添加 Workspace</div><Button className="mt-3" variant="primary" onClick={open_create_workspace}>添加</Button></div> : null}
    </div>
  </div>;
});
