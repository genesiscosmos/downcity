...
export function ChatSurfaceLayout({ header, children }: { /** 对话 Header。 */ header: ReactNode; /** 对话主体。 */ children: ReactNode }) {
  return <MainViewLayout><header className="header-drag-region flex h-10 w-full flex-none items-center gap-2 px-2">{header}</header><MainViewBody>{children}</MainViewBody></MainViewLayout>;
}
