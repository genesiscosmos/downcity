  ...
  return <div role="img" aria-label={activity_label}>
    <div className="min-w-0 overflow-x-clip pb-1">
      <div className="w-full min-w-0">
        <div className="mb-2 grid h-4 min-w-0 gap-[2px] text-3xs text-muted-foreground sm:gap-1" style={{ gridTemplateColumns: `repeat(${heatmap.weeks.length}, minmax(0, 1fr))` }}>
