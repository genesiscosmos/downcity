...
const button_variants = cva(
  "inline-flex flex-none items-center justify-center whitespace-nowrap rounded-md border-none bg-transparent text-muted-foreground outline-none transition-colors hover:bg-interaction-hover hover:text-foreground data-[popup-open]:bg-interaction-selected data-[popup-open]:text-foreground data-[popup-open]:hover:bg-interaction-active focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary: "bg-primary/90 text-primary-foreground/80 hover:bg-primary hover:text-primary-foreground data-[popup-open]:bg-primary data-[popup-open]:text-primary-foreground [&_svg]:text-primary-foreground",
        destructive: "bg-destructive/10 text-destructive hover:bg-destructive/20 hover:text-destructive data-[popup-open]:bg-destructive/20 data-[popup-open]:text-destructive",
        default: "",
      },
      size: {
        default: "h-6 w-auto min-w-0 gap-1 px-1.5 text-[0.6875rem] leading-4 [&_svg]:size-3.5",
        icon: "size-6 shrink-0 p-0 [&_svg]:size-3.5",
        full: "h-6 w-full justify-start gap-1 px-1.5 text-[0.6875rem] leading-4 [&_svg]:size-3.5",
