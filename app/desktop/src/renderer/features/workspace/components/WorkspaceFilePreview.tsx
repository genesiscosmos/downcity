...
export function WorkspaceFileMarkdownBody({ content, class_name }: {
  ...
  return <article className={cn("min-h-full w-full px-5 py-5 text-[0.875rem] leading-[1.7] text-foreground md:px-6 md:py-6", class_name)}><Markdown text={content} mode="static" /></article>;
}
