...
export function PluginView({ plugin, controller }: PluginViewProps) {
  ...
  return <div className="flex h-full min-h-0 min-w-0 flex-1 bg-background"><MainViewLayout><MainViewHeader title={<span className="flex min-w-0 items-center gap-2"><TbComponents className="text-muted-foreground" /><span className="truncate">{plugin.title}</span></span>} /><MainViewBody><div className="min-h-0 min-w-0 flex-1 overflow-y-auto"><div className="mx-auto w-full max-w-[42rem] px-6 pb-12 pt-14">
