...
export async function manageEnv(a: EmbassyAdmin, _baseUrl: string, runtime: admin_tui_runtime): Promise<void> {
  while (true) {
...
async function listAllEnv(a: EmbassyAdmin, runtime: admin_tui_runtime): Promise<void> {
  try {
...
async function upsertEnv(a: EmbassyAdmin, runtime: admin_tui_runtime): Promise<void> {
...
async function updateEnv(a: EmbassyAdmin, runtime: admin_tui_runtime): Promise<void> {
...
async function removeEnv(a: EmbassyAdmin, runtime: admin_tui_runtime): Promise<void> {
  const key = await runtime.text(t({ zh: "key", en: "key" }));
  if (!key) return;
  try {
...
async function refreshEnv(a: EmbassyAdmin, runtime: admin_tui_runtime): Promise<void> {
  try {
...
async function fetchCurrentEnv(a: EmbassyAdmin): Promise<{ key: string; value: string }[]> {
  try {
