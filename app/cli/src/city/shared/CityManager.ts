 ...
 * - Federation 与全局 Power 管理直接放在 Agents 首页的设置分组。
...
import { runInteractivePowerManager } from "@/city/command/PowerCommand.js";
...
async function run_city_list_action(
  ...
  if (action === "powers") await runInteractivePowerManager();
