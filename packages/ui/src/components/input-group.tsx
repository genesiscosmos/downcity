...
const InputGroup = ({ className, ...props }: React.ComponentProps<"div">) => <div className={cn("flex min-h-9 items-center rounded-lg border border-transparent bg-control-surface text-foreground transition-colors hover:bg-control-hover focus-within:bg-control-hover", className)} {...props} />;
