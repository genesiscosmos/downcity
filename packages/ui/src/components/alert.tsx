...
const alert_variants = cva("relative flex w-full gap-2 rounded-lg border px-3 py-2.5 text-sm", { variants: { variant: { default: "border-border bg-surface-subtle text-foreground", destructive: "border-destructive/20 bg-destructive/10 text-destructive" } }, defaultVariants: { variant: "default" } });
