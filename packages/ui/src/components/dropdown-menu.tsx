...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex w-full cursor-default select-none items-center gap-2.5 rounded-lg px-2 py-1.5 text-left text-xs text-foreground/80 outline-none transition-colors focus:bg-interaction-hover focus:text-foreground data-highlighted:bg-interaction-hover data-inset:pl-8 data-[variant=destructive]:text-destructive data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:size-3.5 [&_svg]:shrink-0",
        className,
      )}
      {...props}
    />
