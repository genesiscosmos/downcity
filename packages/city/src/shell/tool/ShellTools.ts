...
function flatten_shell_action_response(params: {
  ...
  return {
    ...
    sandbox: shell_snapshot.sandbox_mode || (shell_snapshot.sandboxed === false ? "unrestricted" : "safe"),
    ...
    sandbox_backend: shell_snapshot.sandbox_backend || null,
    sandbox_network_mode: shell_snapshot.sandbox_network_mode || null,
    sandbox_policy_fingerprint: shell_snapshot.sandbox_policy_fingerprint || null,
    sandbox_dir: shell_snapshot.sandbox_dir || null,
    sandbox_home_dir: shell_snapshot.sandbox_home_dir || null,
    sandbox_tmp_dir: shell_snapshot.sandbox_tmp_dir || null,
    sandbox_cache_dir: shell_snapshot.sandbox_cache_dir || null,
...
function flatten_shell_list_response(params: {
  ...
  return {
    ...
    sessions: (params.response.sessions || []).map((snapshot) => ({
      ...
      sandbox: snapshot.sandbox_mode || (snapshot.sandboxed === false ? "unrestricted" : "safe"),
      sandbox_policy_fingerprint: snapshot.sandbox_policy_fingerprint || null,
