...
export async function invoke_plugin_call_tool(
  ...
  try {
    ...
    const plugins = turn_context.step.extensions
      ? turn_context.step.extensions as unknown as import("@downcity/agent/host").AgentPluginExecutionView
      : params.plugins;
...
export async function invoke_plugin_read_tool(
  ...
  try {
    const plugins = params.turn_context.step.extensions
      ? params.turn_context.step.extensions as unknown as import("@downcity/agent/host").AgentPluginExecutionView
      : params.plugins;
