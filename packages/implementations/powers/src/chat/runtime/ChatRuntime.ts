/** Chat Power 的 City 级 Bot Account、Inbox、Outbox 与 Agent Turn 运行时。 */
...
export class ChatRuntime {
  ...
  constructor(private readonly context: PowerLifecycleContext) {
