/**
 * TaskActionInput：task power runtime 的 CLI 输入映射模块。
 *
 * 关键点（中文）
...
import type { PowerActionCommandInput } from "@downcity/city/power";
...
function parseBooleanLike(value: PowerJsonValue | undefined): boolean | undefined {
...
function getStringOpt(
  opts: Record<string, PowerJsonValue>,
  key: string,
): string | undefined {
