 ...
 *
 * 约定（中文）
 * - task root: `<TaskPower lifecycle storage>/tasks/`
 * - definition: `<TaskPower lifecycle storage>/tasks/<taskId>/task.md`
 * - run dir: `<TaskPower lifecycle storage>/tasks/<taskId>/<timestamp>/`
 *
