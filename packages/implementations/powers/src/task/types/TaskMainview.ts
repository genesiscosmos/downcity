/** Task Power Mainview 与宿主 action 之间的 JSON 协议。 */
...
import type { TaskSchedulerReloadResult } from "./TaskPowerTypes.js";
import type { TaskDefinitionIssue } from "./TaskPowerTypes.js";
