...
The Power page works without a Profile. Use its Workspace, Personal, and Discover tabs to read installed Skill instructions, search the public catalog, install Skills, or remove them from a selected scope.
