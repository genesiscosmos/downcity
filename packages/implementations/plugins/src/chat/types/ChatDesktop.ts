/** Chat Plugin Desktop Sidebar/Mainview 使用的序列化 View 类型。 */

import type { PluginHostAgent, PluginHostWorkspace } from "@downcity/city/plugin";
...
export interface ChatDesktopSnapshot {
  ...
  /** 用户可以选择的 Agent。 */
  agents: PluginHostAgent[];
  /** 用户可以选择的 Workspace。 */
  workspaces: PluginHostWorkspace[];
}
