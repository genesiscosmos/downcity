...
Provides long-term memory through one `MemoryPlugin`.
...
City only supplies the shared Memory root. Storage, recall, capture, and access isolation remain inside `MemoryPlugin`.
