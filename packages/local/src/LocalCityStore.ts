...
import { LocalDatabase } from "@/store/LocalDatabase.js";
import { LocalCrypto } from "@/store/LocalCrypto.js";
import { LocalConfigRepository } from "@/store/LocalConfigRepository.js";
import { LocalPluginLoader, type LocalPluginType } from "@/store/LocalPluginLoader.js";
import { LocalPluginRepository } from "@/store/LocalPluginRepository.js";
import { LocalEmbassySession } from "@/store/LocalEmbassySession.js";
import { resolve_local_agent_env } from "@/store/LocalEnvironment.js";
import { resolve_local_root_path } from "@/store/LocalPaths.js";
import type {
  LocalAgentConfig,
...
/** 模型创建器；由本地 Store 默认使用 Embassy User AIService。 */
...
export class LocalCityStore implements CityStore {
  ...
  constructor(options: LocalCityStoreOptions & { model_resolver?: LocalModelResolver } = {}) {
