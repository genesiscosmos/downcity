/** Organizations Service 的 PostgreSQL Schema 与幂等 DDL。 */

import { integer, pgTable, text } from "drizzle-orm/pg-core";

/** Organization 主表。 */
export const pg_organizations = pgTable("service_organizations", {
...
export const pg_organization_memberships = pgTable("service_organization_memberships", {
...
export const pg_organization_owner_slots = pgTable("service_organization_owner_slots", {
  city_id: text("city_id").notNull(),
  user_id: text("user_id").notNull(),
...
export const pg_organization_join_requests = pgTable("service_organization_join_requests", {
...
/** 撤权事件 Outbox。 */
export const pg_organization_events = pgTable("service_organization_events", {
...
/** PostgreSQL 完整数据库约束，必须在通用建表器前执行。 */
export const pg_organizations_ddl = [
...
/** PostgreSQL 方言下的全部 Organizations 表。 */
export const pg_organization_tables = {
  organizations: pg_organizations,
  memberships: pg_organization_memberships,
  owner_slots: pg_organization_owner_slots,
  join_requests: pg_organization_join_requests,
  events: pg_organization_events,
};
