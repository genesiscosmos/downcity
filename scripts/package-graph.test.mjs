...
test("分组 package 与应用 package 都按 manifest 身份解析真实目录", () => {
  ...
  assert.equal(resolve_package_path(workspace_root, "powers"), "packages/implementations/powers");
  assert.equal(resolve_package_path(workspace_root, "sandbox-microsandbox"), "packages/implementations/sandboxes/microsandbox");
