...
```mermaid
flowchart LR
    Host["SDK host"] --> Workspace["Workspace<br/>project resources and security boundary"]
    Workspace --> Agent["Agent<br/>capability composition root"]
    Agent --> Session["Session<br/>stateful execution container"]
...
| `SessionRunContext` | Explicit snapshot for one execution | Long-lived Agent state |
