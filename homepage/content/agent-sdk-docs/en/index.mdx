...
`agent.dispose()` releases Agent-level Plugin lifecycle and ActionSchedule resources, then releases every Session and Workspace resource it currently uses. The project directory never receives `.downcity`.
