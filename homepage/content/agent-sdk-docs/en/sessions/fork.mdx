...
A successful fork records one `history-fork` Action at the end of the new Session's timeline, describing where the history came from. The source Session gets no record of the fork.
