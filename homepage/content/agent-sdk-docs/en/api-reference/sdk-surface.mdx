...
- `City`: own Workspaces, the Plugin catalog, shared instances, and Agent bindings.
...
- `city.plugins`: provide Plugins, manage Agent bindings, and call main actions.
...
- `PluginContext`: the restricted City projection for the current Agent/Workspace/Session/Turn; hosts should not acquire or retain it.
