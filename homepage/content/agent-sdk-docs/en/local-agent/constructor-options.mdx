...
description: Detailed explanation of Workspace and the local Agent id, instruction, model, env, tools, and plugins options
---
...
- multiple Agents may share one Workspace
- the caller owns the Workspace lifecycle
