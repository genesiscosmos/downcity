...
A newly registered plugin remains `initializing` until lifecycle startup finishes. Actions, availability checks, system blocks, and hooks wait for that startup barrier before executing.
