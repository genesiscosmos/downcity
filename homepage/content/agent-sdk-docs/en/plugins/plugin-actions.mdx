...
- `context` is the City-created scope capability with restricted City, Agent, Workspace, Session, Turn, Profile, and Storage handles.
...
`context.city.plugins.run_action()` for another Plugin bound to the current Agent. Application code
