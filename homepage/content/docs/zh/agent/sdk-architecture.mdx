...
- `@downcity/agent` 依赖 Workspace 协议，并负责解释宿主 Storage 中的 Agent 领域状态。
...
| `@downcity/city` | City、Plugin runtime、Hook 调度、共享生命周期、HTTP/RPC transport、本地宿主数据 | Agent 执行内核、具体内建 Plugin |
