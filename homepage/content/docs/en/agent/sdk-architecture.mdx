...
`@downcity/city` remain owned by the host and must be closed separately.
...
| `@downcity/city` | Agent index and HTTP/RPC transports | Local configuration repository and Agent execution state |
