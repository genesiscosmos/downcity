...
- `@downcity/agent` depends on the Workspace protocol and interprets host Storage for Agent domain state.
...
| `@downcity/city` | City, Plugin runtime, Hook scheduling, shared lifecycle, HTTP/RPC transports, local host data | Agent execution internals, concrete built-in Plugins |
