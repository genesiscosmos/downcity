...
The service supports better-sqlite3 and PostgreSQL. It rejects D1 because D1 does not provide the
required interactive multi-table transactions. Production deployments should configure a
Federation Queue adapter for Outbox retries.
