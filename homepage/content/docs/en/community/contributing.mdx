...
# Add upstream remote
git remote add upstream https://github.com/genesiscosmos/downcity.git
```
...
1. Push to your fork
2. Create pull request to `genesiscosmos/downcity:main`
3. Fill PR template:
...
- [GitHub Issues](https://github.com/genesiscosmos/downcity/issues) - Bug reports
...
Contributors are recognized in:
- [Contributors](https://github.com/genesiscosmos/downcity/graphs/contributors)
- Release notes
- Annual highlights
...
1. Look for [good first issues](https://github.com/genesiscosmos/downcity/labels/good-first-issue)
