...
main lifecycle. During `start()`, `plugin.action()` registers Sidebar/Mainview Actions and
...
One Plugin ID maps to one instance and one lifecycle per City. City injects the selected
