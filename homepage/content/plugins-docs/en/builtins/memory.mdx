...
The built-in City assembly allocates one root for a Memory Plugin/Profile. The Provider separates City, Agent, User, and Workspace logical scopes inside it:
...
A custom registration receives its storage path from City:
