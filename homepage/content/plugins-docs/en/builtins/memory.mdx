...
This is a File Adapter convention, not an `@downcity/agent` or `@downcity/city` contract. Set an absolute `root_path` in the Plugin configuration to override it.
