...
Chat manages queues and channels in its own Plugin Mainview. Create or select a Profile on the Chat Plugin page in Desktop, then let an Agent reference it:

```bash
# Configure primary in the Desktop Mainview
