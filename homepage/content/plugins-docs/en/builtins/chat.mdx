...
- channel connections and queue workers belong to City's unique ChatPlugin instance and are isolated by Context
- Agent/Workspace routing is established and released through `connect/disconnect` scope lifecycle
