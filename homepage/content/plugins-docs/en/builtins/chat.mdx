...
Chat manages queues and channels in its own Config. Create or select a Profile under Desktop Settings / Plugins, then let an Agent reference it:

```bash
# Configure primary under Desktop Settings / Plugins
