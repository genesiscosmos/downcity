...
City projects Sound configuration into `PluginContext.config` for the current Agent. The AI service
comes from `PluginContext.city.embassy.user.ai`; it does not belong to Agent.
