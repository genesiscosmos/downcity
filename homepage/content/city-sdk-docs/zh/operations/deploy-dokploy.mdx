...
产品前端和应用通过 Embassy 调用 Federation：
...
可信后端使用 Embassy Admin 子域携带管理员会话 Token：
...
完整 SDK 能力继续看 [Embassy User](/zh/city-sdk-docs/reference/city-user) 和 [Embassy Admin](/zh/city-sdk-docs/reference/city-admin)。
