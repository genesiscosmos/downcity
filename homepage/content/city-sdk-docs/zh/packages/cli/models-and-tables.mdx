...
这也是为什么这页要和 [Store 与 Table](/zh/city-sdk-docs/packages/federation/store-and-table) 一起理解：

- `@downcity/agent` 负责受控数据层
...
- 想理解这些表的来源，读 [Store 与 Table](/zh/city-sdk-docs/packages/federation/store-and-table)
