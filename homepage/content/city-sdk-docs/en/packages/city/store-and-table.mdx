...
You should still prefer services, and `FederationAdmin` for city-facing or managed entry points.

### Frontends should not treat tables as their API

City-side callers should continue to use `User City` and `FederationAdmin`, not raw table access.
