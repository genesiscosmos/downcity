...
description: "Agent, AgentSessions, Session, execution runtime, and RemoteAgent."
---

`@downcity/agent` provides Agent, AgentSessions, Session, the execution runtime, RemoteAgent, and
City. Agents do not own Plugins. City owns the Plugin catalog, shared instances, and lifecycle;
Plugin author contracts live in `@downcity/plugin`. Workspace resources come from
`@downcity/workspace`.
