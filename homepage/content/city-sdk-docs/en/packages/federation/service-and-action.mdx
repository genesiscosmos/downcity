...
description: "How Service, Action, the unified route space, and AIService relate inside @downcity/federation."
---

`Service` and `Action` are the main business organization units inside `@downcity/federation`.
...
- For hooks and extension around actions, read [Hooks and Service Mounting](/en/city-sdk-docs/packages/federation/hooks-and-service)
- For product-side calling, read [@downcity/federation](/en/city-sdk-docs/packages/federation/federation)
