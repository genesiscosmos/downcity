...
description: "The boundary between fed, city, FederationAdmin, and direct database inspection, and when the CLI is the better tool."
---
...
- `FederationAdmin`: trusted programmatic management
