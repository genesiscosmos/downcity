...
That is why this page fits naturally with [Store and Table](/en/city-sdk-docs/packages/federation/store-and-table):

- `@downcity/agent` owns the controlled data layer
...
- For the data layer behind these tables, read [Store and Table](/en/city-sdk-docs/packages/federation/store-and-table)
