---
title: SDK Overview
description: "The Downcity SDK is split by role: User City owns Federation calls, while FederationAdmin owns trusted-side management calls."
---

This page does one job: it pulls the calling model of `@downcity/city` into one reference overview.

If you want the integration story first, start with [@downcity/city](/en/city-sdk-docs/packages/city/federation). If you need concrete method details, continue to [User City](/en/city-sdk-docs/reference/city-user) and [FederationAdmin](/en/city-sdk-docs/reference/city-admin).
...
4. For trusted-side management, read [FederationAdmin](/en/city-sdk-docs/reference/city-admin)
