...
description: "How AccountsService() works with FederationAdmin in trusted environments for users, sessions, and related admin-side reads."
---
...
## Why this is tied to `FederationAdmin`
