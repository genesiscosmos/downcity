...
description: "How AccountsService() works with Embassy Admin in trusted environments for users, sessions, and related admin-side reads."
---
...
## Why this is tied to `Embassy Admin`
