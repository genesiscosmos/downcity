...
支持 `Mod+B`、`Mod+L`、`Mod+I`、`Mod+,` 等组合键。快捷键动作由宿主应用注册，UI SDK 不预设业务行为。
...
- 导出：`ChatPanel`、`ChatHistory`、`ChatMessage`、`ChatComposer`、`session_message_to_chat_message`
- 导出类型：`DowncityChatPanelProps`、`DowncityChatMessage`、`DowncityChatThread`、`DowncityChatStatus`、`DowncityChatSubmitInput`
